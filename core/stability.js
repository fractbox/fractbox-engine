...
export const BOUNDING_FOLDS = Object.freeze([
  ...
  "mirrorShells", // id 63 — radial tent fold: folded radius ≤ Offset + Spacing/2
  //                unconditionally (#635 — the spec review's open question,
  //                answered yes: the cap is structural, like sphereFold's).
  "wallpaperFold", // id 65 — #632: folds x,y into a bounded wallpaper chamber
  //                (z free — the surfFold precedent for partial-axis bounding).
  "spaceGroupFold", // id 66 — #632: folds ALL of space into one bounded
  //                crystallographic chamber — a box-fold-family cap on every axis.
]);
