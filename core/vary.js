...
export const TOUCHY = new Set([
  ...
  "modFold",
  "tentFold",
  "mirrorShells", // #635 — absolute radial pitch/offset, same leash as tentFold
  "wallpaperFold", // #632 — absolute tile pitch, same leash as tentFold
  "spaceGroupFold", // #632 — absolute cell dims, same leash as tentFold
  "brickFold",
  "hingeFold", // #633 — absolute cut offset + cut angle place the tear against
  //             the figure itself; a full-range roll slices the body apart
  "absOffsetFold",
  "zFold",
]);
