...
There are **68 operators**. List them at runtime:
...
| `streamlines.js` | field streamlines — DE-advected glow particles (WebGPU compute)             |
| `envmap.js`     | user environment map + triplanar surface texture — the pure math            |
